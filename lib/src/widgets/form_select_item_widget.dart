...
class _FormSelectItemWidgetState extends State<FormSelectItemWidget> {
  ...
  void initState(){
    ...
    //selectedValue = widget.formItem.initialValue;
    /*
    ...
    widget.formItem.onFilterChange = ((value){
      print("FILTER CHANGE: " + value.toString() );
      widget.formItem.selectFieldController.findAll().then((results){
        setState(() {
          items = results;
        });
    ...
    //widget.formItem.onParentChange = ( (valueParent){} );
    //TODO quizás acá falte un onChangeParent o algo del estilo para combos anidados.
