...
import 'package:dynamic_form/src/model/validators/form_validator.dart';

class FormMaxLengthValidator extends FormValidator {

  int maxLength;

  FormMaxLengthValidator(this.maxLength, {super.defaultErrorMessage="Max length exceeded"});
